...
?>
<div class="subMenu"><img src="img/wbicon.png"/></div>
<?php /*
<html>
<head>
<title>Test</title>
...
<?
$strSQL = "SELECT * FROM `shoppingcart_webboard` ";
...
?>
<div class = "wb">
	<div style="margin: 0px 40% 10px 40%;">
		<a href="NewQuestion.php" style="text-align:right;"><div id="webboard-button-new">New Topic</div></a>
	</div>
	<table width="" border="0" class="CSSTableGenerator">
	  <tr>
